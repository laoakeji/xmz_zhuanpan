...
<!-- <div class="cl pd-5 bg-1 bk-gray mt-20"> 
  ...
  <a class="btn btn-primary radius" onclick="admin_add('添加','<?php echo U('Pangu/Index/edit');?>?table=news&type=<?php echo ($type); ?>','1000','600')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
   </span> 
</div> -->
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
          ...
          <th width="150">地址</th>
 					<th width="150">购机凭证</th>
          <th width="150">实物照片</th>
          <!-- <th width="120">操作</th> -->
				</tr>
			</thead>
			<tbody>
          ...
          <td><?php echo (date("Y-m-d ",$vo["ttime"])); ?></td>
          <td><?php echo (date("Y-m-d ",$vo["btime"])); ?></td>
          <td><?php echo ($vo["cityname"]); ?></td>
          <td><img src="<?php echo ($vo["img_buy"]); ?>" style="width:120px;height: 60px"></td>
					<td><img src="<?php echo ($vo["img_model"]); ?>" style="width:120px;height: 60px"></td>
					<!-- <td class="f-14 td-manage">
            <a style="text-decoration:none" class="ml-5" onClick="admin_edit('编辑','<?php echo U('Index/edit');?>?table=news&type=<?php echo ($type); ?>&id=<?php echo ($vo["id"]); ?>','1000','800')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
