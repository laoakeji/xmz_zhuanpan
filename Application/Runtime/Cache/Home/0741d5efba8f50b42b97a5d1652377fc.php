...
<div class="index index3-bg">
 <div class="content">
   ...
   <div class="title"><span class="title-border">当前已打卡人数<em><?php echo ($list["num"]); ?>/10</em>人</span></div>
   <div class="jindu">
   ...
   <div class="jine">
    ...
    <?php if($status == 2): ?><div class="daka">您已完成打卡,已贡献2元！</div>
    <?php else: ?>
      <div class="daka">您已打卡成功，目前已有<em><?php echo ($count); ?></em>人参于打卡</div><?php endif; ?>
   
   <div class="zhezhao"></div>
   
   <div class="anniu">
      <?php if($status == 2): else: ?>
        <a class="kanjia-btn" >找朋友打卡</a><?php endif; ?>
