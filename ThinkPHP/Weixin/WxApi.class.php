...
class WxApi {
	...
	public $token = "";
	public $tuling = 0;
	public $mchid = "1339638501"; //商户号
	//public $privatekey = "YF8Ogg3p0YPnWbNaR0g7kE89b4xCkzNn"; //私钥
	public $privatekey = "7c6f425b5ceeadcea501d85a36af73a5"; //私钥
	...
	public function wxHttpsRequestPem($url, $vars, $second = 30, $aHeader = array()) {
		...
		curl_setopt($ch, CURLOPT_SSLCERT, "/www/web/999cuohela/public_html/ThinkPHP/Weixin/cert/apiclient_cert.pem");
		//默认格式为PEM，可以注释
		curl_setopt($ch, CURLOPT_SSLKEYTYPE, 'PEM');
		curl_setopt($ch, CURLOPT_SSLKEY, "/www/web/999cuohela/public_html/ThinkPHP/Weixin/cert/apiclient_key.pem");

		curl_setopt($ch, CURLOPT_CAINFO, 'PEM');
		curl_setopt($ch, CURLOPT_CAINFO, "/www/web/999cuohela/public_html/ThinkPHP/Weixin/cert/rootca.pem");
	...
	public function weixin_jsapi_ticket() {
		...
		return THINK_PATH . 'Weixin/js_ticket.json';
	}
	public function weixin_access_token() {
		//echo "ROOT_PATH.'/Public/cache/js_ticket.json'";exit;
		return THINK_PATH . 'Weixin/access_token.json';
	}
	/****************************************************
...
//上传对媒体文件
	...
	public function send_money($openid, $money) {
		$arr3['descc'] = '璞竹创业天使提现';
		$arr3['spbill_create_ip'] = '114.55.99.35';
		$c_time = time();
	...
	public function payper_parameter($openid, $money = '', $arr, $db = null) {
		...
		$this->setParameter('sign', $this->wxMd5Sign($content, 'YF8Ogg3p0YPnWbNaR0g7kE89b4xCkzNn'));
